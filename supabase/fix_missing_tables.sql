-- ============================================================
-- TechieBrains: Fix Schema Migration
-- Run this ENTIRE script in your Supabase SQL Editor:
-- https://supabase.com/dashboard/project/vexemcdcxdrpefzwfwfx/sql/new
-- ============================================================

-- 1. Create enum types (safe: skips if already exists)
do $$
begin
...
-- 2. Create profiles table (safe: skips if already exists)
...
-- 3. Drop avatar column if it exists (no longer used in code)
alter table public.profiles drop column if exists avatar;

-- 4. Create resumes table (THIS IS THE MISSING TABLE)
...
-- 10. Drop then re-create all RLS policies (safe to re-run)
